...
<body class="vertical-layout vertical-compact-menu 1-column  bg-cyan bg-lighten-2 menu-expanded fixed-navbar"
                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header border-0">
                                <div class="card-title text-center">
                                    <img src="http://admin.indiansat.tk/mp/a.png" width="100" alt="branding logo">
                                </div>
                                @if($errors->any())
                                    <div class="alert alert-danger">{{$errors->first()}}</div>
                                @endif
                                <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                                    <span>Login with NewP</span>
                                </h6>
                            </div>
                                    ...
                                    <form class="form-horizontal" action="/login" novalidate method="POST">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control input-lg" id="user-name" placeholder="Your Username"
                                                   tabindex="1" required data-validation-required-message="Please enter your username." name="username">
